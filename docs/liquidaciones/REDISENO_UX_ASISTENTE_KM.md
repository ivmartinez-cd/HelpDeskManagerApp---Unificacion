...
Estado: **Fase 0 entregada; decisiones §4 tomadas con el usuario el 2026-08-20 (ver columna
"Decidido"); a la espera del OK formal para Fase 1.** Fecha: 2026-08-20.
...
el contrato de paridad que Fase 2 verifica ítem por ítem (columna "✓ F2" vacía a propósito).
