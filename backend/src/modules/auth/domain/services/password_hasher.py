...
class PasswordHasher(Protocol):
    ...
    def dummy_hash(self) -> PasswordHash:
        """Hash fijo contra el que verificar cuando el email no existe, para
        que el login tarde lo mismo que con un usuario real (anti-enumeración
        por timing). Calculado una sola vez por proceso."""
        ...
