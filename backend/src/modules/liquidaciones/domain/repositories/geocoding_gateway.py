...
candidato (ver `services/geolocalizacion.py`) los usa para distinguir un match
preciso (ROOFTOP / RANGE_INTERPOLATED / intersección) de un centro geométrico
de ruta — el muestreo de calidad 2026-08-15 mostró que "Ruta X KM Y" devuelve
el centro de toda la ruta, a kilómetros del punto real."""
