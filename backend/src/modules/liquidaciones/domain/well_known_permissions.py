...
hasta que exista frontend. `create`/`approve`/`export` quedan sin `Permission` propio
todavía: los agrega el caso de uso que primero los necesite (importación, aprobación de
liquidación, exportación), no antes."""
