from src.modules.tareas_varias.application.dtos.solicitud_tv_dto import SolicitudTvDTO
from src.modules.tareas_varias.domain.entities.solicitud_tv import SolicitudTv
